...
# PI01
server_address = "192.168.87.170"

pull_address = f"tcp://{server_address}:5557"
...
sender.connect(f"tcp://{server_address}:5558")


# Socket to receive Get Chunk messages from the controller
subscriber = context.socket(zmq.SUB)
#subscriber.connect("tcp://localhost:5559")
subscriber.connect(f"tcp://{server_address}:5559")
